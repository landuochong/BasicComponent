...
XLogger::XLogger(TLogLevel _level, const char* _tag, const char* _file, const char* _func, int _line, bool _trace)
:m_info(), m_message(), m_exp(NULL), m_isinfonull(false) {
	m_info.level = _level;
	m_info.tag = _tag;
